...
type AppRouteHandlerRoutes = "/api/analytics/data" | "/api/analytics/export-csv" | "/api/analytics/export-pdf" | "/api/analytics/track-click" | "/api/analytics/track-view" | "/api/auth/[...nextauth]" | "/api/auth/signup" | "/api/coaching/bookings" | "/api/coaching/bookings/[id]" | "/api/coaching/training-plans" | "/api/coaching/training-plans/[id]" | "/api/coaching/upload-pdf" | "/api/create-checkout-session" | "/api/cron/expire-trials" | "/api/links" | "/api/links/[id]" | "/api/media" | "/api/media/[id]" | "/api/profile" | "/api/promo-codes/validate" | "/api/public/booking-request" | "/api/races" | "/api/races/[id]" | "/api/races/extract-logo" | "/api/sponsors" | "/api/sponsors/[id]" | "/api/sponsors/extract-logo" | "/api/upgrade-plan" | "/api/upload" | "/api/webhooks/stripe"
